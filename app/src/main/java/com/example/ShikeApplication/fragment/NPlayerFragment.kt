 ...
 * [NPlayerFragment.OnFragmentInteractionListener] interface
 * to handle interaction events.
 * Use the [NPlayerFragment.newInstance] factory method to
...
class NPlayerFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment NPlayerFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
                NPlayerFragment().apply {
